...
const required = (value) => {
  if (!value) {
    return <div className="invalid-input">Este campo é obrigatório!</div>;
  }
};

const email = (value) => {
  if (!isEmail(value)) {
    return <div className="invalid-input">Este não é um e-mail válido.</div>;
  }
};
...
const isEqual = (value, props, components) => {
  ...
  if (
    ...
    return <div className="invalid-input">As senhas não são iguais!</div>;
  }
};
              ...
              <div className="form row g-3 shadow p-5 mb-5 bg-body rounded">
                <div className="avatar-wrapper shadow">
                  <div className="avatar-add-photo">
                    <img
                      src="./cam_profile.png"
                      alt="Adicionar Foto do Perfil"
                      id="img-add-photo-profile"
                      aria-hidden="true"
                    />
                    <p>ADICIONAR</p>
                    <p>FOTO</p>
