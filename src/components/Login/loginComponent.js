...
import "./login.css";
import logo from '../../images/logo-mama-ativa.png'
        ...
        <Card id="wrap2">
          ...
          <Form onSubmit={this.handleLogin} ref={c => { this.form = c; }}>
            ...
            <div className="container-loogo-mamativa">
                  <img src={logo} tagName="Testes" alt="Logo marca Mama Ativa" className="login-img-logo" />
                </div>
              <div className="form row g-3 form-div">
                ...
                <div align="center"className="form-button">
                  <button
